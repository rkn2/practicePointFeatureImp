...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{dataTypes.png}
    \caption{Enter Caption}
    \label{fig:datatypes}
\end{figure}
...
Fourth, diagnostic tools (scree plots, eigenvalue criteria) determine how many factors to retain.
Fifth, you interpret and name the factors based on which variables load strongly (typically |0.6| or higher). 
If solar radiation, temperature, and thermal expansion load on one factor, label it ``Thermal Stress." 
